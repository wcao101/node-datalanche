...
function getBody(query) {
    ...
    if (query.baseUrl === '/alter_table') {
        ...
        if (query.params.dataset) {
            body.dataset = query.params.dataset;
        }
...
function getUrl(query) {
    ...
    if (url === '/drop_table') {
        if (query.params.dataset) {
            parameters.dataset = query.params.dataset;
        }
    } else if (url === '/get_dataset_list') {
        // do nothing
    } else if (url === '/get_schema') {
        if (query.params.dataset) {
            parameters.dataset = query.params.dataset;
        }
    }
