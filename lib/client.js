...
function DLException(statusCode, name, message, req, res) {
    Error.call(this);
...
DLException.prototype.__proto__ = Error.prototype;
...
Client.prototype.query = function(q, callback) {
    ...
    function(err, res, resBody) {
        ...
        if (resBody !== undefined && resBody !== null && resBody !== '') {
