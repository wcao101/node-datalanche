...
Query.prototype.alterTable = function(datasetName) {

    this.urlType = 'post';
    this.baseUrl = '/alter_table';
    this.params.dataset = datasetName.toString();
...
Query.prototype.createTable = function(datasetName) {
...
Query.prototype.deleteFrom = function(datasetName) {
...
Query.prototype.description = function(text) {
    ...
    this.params.description = text.toString();
...
Query.prototype.dropColumn = function(columnName) {
    ...
    this.params.dropColumns.push(columnName.toString());

    return this; // method chaining
};

Query.prototype.dropTable = function(datasetName) {
...
Query.prototype.getDatasetList = function() {

    this.urlType = 'get';
    this.baseUrl = '/get_dataset_list';

    return this; // method chaining
};

Query.prototype.getSchema = function(datasetName) {

    this.urlType = 'get';
    this.baseUrl = '/get_schema';
    this.params.dataset = datasetName.toString();

    return this; // method chaining
};

Query.prototype.insertInto = function(datasetName) {
...
Query.prototype.rename = function(datasetName) {

    this.params.rename = datasetName.toString();
...
Query.prototype.update = function(datasetName) {
