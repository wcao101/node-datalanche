...
Query.prototype.maxSizeGB = function(integer) {

    this.params.max_size_gb = integer;
    return this; // method chaining
};
...
Query.prototype.dropColumn = function(columnName, cascade) {

    if (!this.params.drop_columns) {
        this.params.drop_columns = [];
    }
    var columnToDrop = {};
    columnToDrop.name = columnName;
    columnToDrop.cascade = cascade || false;
    this.params.drop_columns.push(columnToDrop);
    return this; // method chaining
};
...
Query.prototype.usingMethod = function(text) {

    this.params.using_method = text;
    return this; // method chaining
};
...
Query.prototype.select = function(columns) {
    ...
    if (columns === '*') {
        throw new Error('please use selectAll() instead of select("*")');
    }
