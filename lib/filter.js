...
Filter.prototype.and = function(filterList) {
...
Filter.prototype.in = function(value) {
    this._hasNot = false;
    this._operator = '$in';
    this._value = value;
    return this; // allow method chaining
...
Filter.prototype.notIn = function(value) {
    this._hasNot = true;
    this._operator = '$in';
    this._value = value;
    return this; // allow method chaining
...
Filter.prototype.or = function(filterList) {
    this._filters = filterList;
    this._operator = '$or';
    return this; // allow method chaining
}
